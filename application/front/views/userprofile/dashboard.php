<div class="container pt15 main-dashboard">
    <div class="left-part">
        ...
        <div class="media-box latest_photos">
            ...
            <div class="media-display">
                <div class="all-meda" ng-repeat="imageData in postImageData">
                    <a href="javascript:void(0)" class="hover-shadow cursor"><img ng-src="<?php echo USER_POST_THUMB_UPLOAD_URL ?>{{imageData.filename}}" alt="Image"></a>
                </div>
            </div>
        </div>
        <div class="media-box latest_video">
            ...
            <div class="media-display">
                <div class="all-meda" ng-repeat="videoData in postVideoData">
                    <a href="">
                        <video controls width = "100%" height = "92" preload="metadata">
                            <source ng-src="<?php echo USER_POST_MAIN_UPLOAD_URL ?>{{videoData.filename}}#t=0.1" type="video/mp4">
                        </video>
                    </a>
                </div>
            </div>
        ...
        <div class="media-box latest_pdf">
            <div class="dash-left-title">
                <h3><i class="fa fa-file"></i> Article coming soon</h3>
            </div>
            <div class="media-display" >
    ...
    <div class="middle-part">
        <div class="add-post">
            ...
            <div class="post-box-bottom">
                <ul>
                    <li>
                        <a href="javascript:void(0);"  class="opportunity-modal" data-target="#opportunity-popup" data-toggle="modal" id="opportunity-modal">
                    ...
                    <li class="pl15">
                        <a href="javascript:void(0);"  class="ask-question-modal" data-target="#ask-question" data-toggle="modal" id="ask-question-modal">
                    ...
                    <div class="post-box">
                        ...
                        <div class="post-box-bottom" >
                            <ul ng-if="is_edit != 1">
                                ...
                                <li class="pl15">
                                    <a href="javascript:void(0);" class="ask-question-modal post-ask-question-modal" data-target="#ask-question" data-toggle="modal">
                                        <img src="<?php echo base_url('assets/n-images/ask-qustion.png') ?>"><span>Ask Question</span>
                                    </a>
                                </li>
                            </ul>
