        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    echo form_open_multipart('freelancer_apply/edit_insert/'.$users[0]['freelancer_post_reg_id'], $form_attr);
                    ?>
                    <div class="box-body">
                        ...
                        <div class="form-group col-sm-10">
                            ...
                            <input type="text" class="form-control" name="first_name" id="first_name" value="<?php echo $users[0]['freelancer_post_fullname']; ?>">
                        </div>
                        <!-- First Name END -->
                        ...
                        <div class="form-group col-sm-10">
                            ...
                            <input type="text" class="form-control" name="last_title" id="last_title" value="<?php echo $users[0]['freelancer_post_username']; ?>">
                        </div>
                        <!-- Last Name END -->
                        ...
                        <div class="form-group col-sm-10">
                            ...
                            <input type="text" class="form-control" name="email_edit" id="email_edit" value="<?php echo $users[0]['freelancer_post_email']; ?>">
                        </div>
                        <!-- Email END -->
                        ...
                        <div class="form-group col-sm-10">
                            ...
                            <input type="text" class="form-control" name="phoneno" id="phoneno" value="<?php echo $users[0]['freelancer_post_phoneno']; ?>">
                        </div>
                        <!--phone number END -->    
                        ...
                        <div class="form-group col-sm-10">
                            ...
                            <input type="text" class="form-control" name="skype_id" id="skype_id" value="<?php echo $users[0]['freelancer_post_skypeid']; ?>">
                        </div>
                        <!--Skype Id END -->
                         <!-- Country START -->
                        <div class="form-group col-sm-10">
                            ...
                            <select  name="country" id="country"  class="form-control">
                                ...
                                <?php
                                            ...
                                            if($users[0]['freelancer_post_country'])
                                            {
                                              ?>
                        ...
                        <div class="form-group col-sm-10">
                            ...
                            <select name="state" id="state"  class="form-control">
                               <?php
                                          ...
                                          if($users[0]['freelancer_post_state'])
                                            {
                        ...
                        <div class="form-group col-sm-10">
                            ...
                            <input type="text" class="form-control" name="pincode_no" id="pincode_no" value="<?php echo $users[0]['freelancer_post_pincode']; ?>">
                        </div>
                        <!-- pincode END -->
                        
                         <!--  Professional info START -->
                        <div class="form-group col-sm-10">
                            <label for="professionalinfo" name="professionalinfo" id="professionalinfo">Field</label>
                        ...
                        <div class="form-group col-sm-10">
                            <label for="skills" name="skill" id="professionalinfo">Skill</label>
                        ...
                        <div class="form-group col-sm-10">
                            <label for="professionalinfo" name="professionalinfo" id="professionalinfo">Skill Description *</label>
                            <textarea id="professional_info" name="professional_info"  style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $users[0]['professional_info']; ?></textarea>
                            <?php //echo form_textarea(array('name' => 'short_description', 'id' => 'short_description', 'class' => "textarea", 'style' => 'width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;', 'value' => '')); ?><br>
                        </div>
                        <div class="form-group col-sm-10">
                            <label for="professionalinfo" name="professionalinfo" id="professionalinfo">Hourly</label>
                            <textarea id="professional_info" name="professional_info"  style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $users[0]['professional_info']; ?></textarea>
                            <?php //echo form_textarea(array('name' => 'short_description', 'id' => 'short_description', 'class' => "textarea", 'style' => 'width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;', 'value' => '')); ?><br>
                        </div>
                        <div class="form-group col-sm-10">
                            <label for="professionalinfo" name="professionalinfo" id="professionalinfo">Rate</label>
                            <textarea id="professional_info" name="professional_info"  style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $users[0]['professional_info']; ?></textarea>
                            <?php //echo form_textarea(array('name' => 'short_description', 'id' => 'short_description', 'class' => "textarea", 'style' => 'width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;', 'value' => '')); ?><br>
                        </div>
                        <div class="form-group col-sm-10">
                            <label for="professionalinfo" name="professionalinfo" id="professionalinfo">Fixed Rate</label>
                            <textarea id="professional_info" name="professional_info"  style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $users[0]['professional_info']; ?></textarea>
                            <?php //echo form_textarea(array('name' => 'short_description', 'id' => 'short_description', 'class' => "textarea", 'style' => 'width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;', 'value' => '')); ?><br>
                        </div>
                        <!--  Professional info START -->
