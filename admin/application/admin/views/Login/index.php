        ...
        <div class="login-box">
          <div class="login-logo">
            <a href="javascript:void(0)">
                <!--Monika's Eyebrow-->
                <img src="<?php echo base_url('admin/images/logo.png')?>"/>
            </a>
          </div><!-- /.login-logo -->
            ...
            <p class="login-box-msg">Sign in to start your session</p>
             <?php echo form_open('login/authenticate',array('name'=>'login_frm','id'=>'login_frm','method'=>'POST'));  ?>
              <div class="form-group has-feedback">
                <input name="admin_email" id="admin_email" type="text" class="form-control" placeholder="Email Id">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                <label class="user_err error" for="username" style="color:red;display: none;">Email Required</label>
              </div>
              <div class="form-group has-feedback">
