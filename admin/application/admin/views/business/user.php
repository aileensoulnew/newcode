            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover table-bordered">
                ...
                ?>
                    ...
                    <a href="<?php echo ( $this->uri->segment(3) == 'company_name' && $this->uri->segment(4) == 'ASC') ? site_url($this->uri->segment(1) . '/' . $segment2 . '/company_name/DESC/' . $offset) : site_url($this->uri->segment(1) . '/' . $segment2 . '/company_name/ASC/' . $offset); ?>"> 
                     Company Name
                     </a>

                     <?php echo ( $this->uri->segment(3) == 'company_name' && $this->uri->segment(4) == 'ASC' ) ? '<i class="glyphicon glyphicon-arrow-up">' : (( $this->uri->segment(3) == 'company_name' && $this->uri->segment(4) == 'DESC' ) ? '<i class="glyphicon glyphicon-arrow-down">' : '' ); ?>
                ...
                <tr id="delete<?php echo $user['business_profile_id']?>">
                    ...
                    <td> 
                        <?php  if($user['business_profile_image']) 
                                {
                        ?>
                    ...
                    <td id="active<?php echo $user['business_profile_id']?>">
                        <?php if ($user['status'] == 1) 
                              {
                        ?>
                                    <button class="btn btn-block btn-primary btn-sm"  onclick="deactive_user(<?php echo $user['business_profile_id']; ?>);">Active</button>
                        <?php 
                            }else{ ?>
                    ...
                    <td>
                        ...
                        <button class="btn btn-danger btn-xs" onclick="delete_user(<?php echo $user['business_profile_id']; ?>);">
