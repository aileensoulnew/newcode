...
function commentall(clicked_id) {
    ...
    if (x.style.display === 'block' && y.style.display === 'none') {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "artist/multifourcomment",
            //url: '<?php echo base_url() . "artist/multifourcomment" ?>',
...
function insert_commentimg(clicked_id)
{
    ...
    if (post_commentimg == '') {
        ...
        if (x.style.display === 'block' && y.style.display === 'none') {
            $.ajax({
                type: 'POST',
                url: base_url + "artist/mulimg_commentthree",
                //url: '<?php echo base_url() . "artist/mulimg_commentthree" ?>',
...
function comment_deletetwo(clicked_id)
{
    ...
    $.ajax({
        type: 'POST',
        url: base_url + "artist/mul_delete_commenttwo",
        //url: '<?php echo base_url() . "artist/mul_delete_commenttwo" ?>',
