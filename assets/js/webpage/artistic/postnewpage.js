...
function comment_like1(clicked_id)
 ...
 function comment_delete(clicked_id) {
                        ...
                        function comment_deleted(clicked_id)
                        {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: base_url + "artistic/delete_comment_postnewpage",
                        ...
                        function comment_deletedtwo(clicked_id)
                        {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: base_url + "artistic/delete_commenttwo_postnewpage",
...
function insert_comment(clicked_id)
                        {
                            ...
                            if (x.style.display === 'block' && y.style.display === 'none') {
                                $.ajax({
                                    type: 'POST',
                                    url: base_url + "artistic/insert_commentthree_postnewpage",
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: base_url + "artistic/insert_comment_postnewpage",
...
function post_like(clicked_id)
                        ...
                        function commentall(clicked_id) {
                            ...
                            if (x.style.display === 'block' && y.style.display === 'none') {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: base_url + "artistic/postnewpage_fourcomment",
